...
clothingStock.forEach(({ color, category }) => {
  if (category === "women shirt") console.log(color);
});

// 3b. Console all the different colours available for men shirt which are currently in stock.
console.log("@@@@@");
clothingStock.forEach(({ color, inStock, category }) => {
  if (category === "men shirt" && inStock) console.log(color);
});
console.log("@@@@@");
